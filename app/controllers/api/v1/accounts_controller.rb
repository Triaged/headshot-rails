  ...
  def update_password
    if @user.update_with_password(password_params)
      ...
      render :json => { "message" => "ok" }, :status => 200
    	...
    	render :json=> { "message" => "Error with updating your password" }, :status=>401
    end
  end
...
private
  ...
  def user_params
    params[:user].permit(:first_name, :last_name, :installed_app, :avatar, :department_id, :manager_id, :primary_office_location_id,
